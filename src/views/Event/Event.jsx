...
const Event = ({ id }) => {
    ...
    return (
        <Panel id={id}>
            ...
            <Group>
                <RichCell multiline disabled before={<Avatar size={72} />}>
                    Пикник у Павла
                </RichCell>
            </Group>
            <Group>
                <SimpleCell
                    disabled
                    before={<Icon20FollowersOutline style={{ padding: '0 6px 0 0' }} />}
                >
                    <div className={styles.info}>
                        <Text>30 участников&nbsp;&bull;&nbsp;28 друзей</Text>
                        <UsersStack
                ...
                <SimpleCell
                    disabled
                    before={<Icon20CalendarOutline style={{ padding: '0 6px 0 0' }} />}
                >
                    <Text>10 апр в 20:00 - 11 апр в 23:00</Text>
                </SimpleCell>
            </Group>
            <Tabs>
                <TabsItem onClick={() => setTab('purchases')} selected={tab === 'purchases'}>
                    Покупки
                </TabsItem>
                <TabsItem onClick={() => setTab('balance')} selected={tab === 'balance'}>
                    Баланс
                </TabsItem>
            </Tabs>
            {tab === 'purchases' && (
